...
function IntroBar({ userAddr, setUserAddr, setIsLoading }) {
    ...
    const checkExtension = async () => {
        ...
        evmProvider.api.on("ready", async () => {
            ...
            setSigner(wallet)
            console.log(wallet)
            // setIsLoading("WALLET CONNECTED, FECTCHING YOUR DATA")
            ...
            <div className="introBarContainer">
                <div className="welcomeContainer">
                    {signer ? (
                        <div className="headingContainer">
                            ...
                            {signer._substrateAddress.slice(
                                signer._substrateAddress.length - 4
                            )}{" "}
                        </div>
                    ) : (
                    ...
                    <div className="descContainer">
                        Welcome, check the lastest projects this week
                    </div>
                </div>
                <div className="profileContainer">
                    ...
                    <div className="profilePicContainer">
                        {signer ? (
                            <ProfilePicture
                                address={signer._substrateAddress}
                            />
                        ) : (
                            <></>
                        )}
                    ...
                    {signer ? (
                        ...
                        <Uik.Button
                            onClick={async () => {
                                await checkExtension()
                                setIsLoading(
                                    "WAITING OF REEF WALLET TO CONNECT"
                                )
                                if (typeof window !== "undefined") {
